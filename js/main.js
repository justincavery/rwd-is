...
module.exports = {
    el: '[data-app=nav--primary]',

    data: {
        open: false,
        fixed: false,
        handle: null,
        handle_closed: "Explore",
        handle_open: "Close"
    },
    ...
    created: function() {
        ...
        _this.handle = _this.handle_closed;

        window.addEventListener('scroll', _this.fixNavBar);
    },
    ...
    methods: {
        ...
        toggleMenu: function() {
            ...
            _this.handle = _this.open ? _this.handle_open : _this.handle_closed;
        },
 ...
 * ----------------------------------------//
 */
new Vue(require('./apps/nav--primary'));
},{"./apps/nav--primary":2,"vue/dist/vue":1}]},{},[3]);